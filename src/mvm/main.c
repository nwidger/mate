...
void usage() {
	...
	fprintf(stderr, "Executes maTe class file FILE.  FILE can be specified with or without \".class\" extension.\n");
	...
	fprintf(stderr, "  -s FILE  Specify FILE as a symbol table.  Used with -v to resolve addresses when decoding\n");
	fprintf(stderr, "           instructions.  Symbol tables can be generated by passing the -s switch to the\n");
	fprintf(stderr, "           assembler.  If not specified, an attempt is made to load a symbol table by\n");
