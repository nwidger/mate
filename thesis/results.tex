...
enabled the overhead ranged from $109%$ to $7,598%$.  The best DMP run
was using a 10,000 instruction quantum, full serial mode, an ownership
table depth of 5 with an average time of .48 seconds.
