/* Niels Widger
 * Time-stamp: <23 Nov 2010 at 20:40:45 by nwidger on macros.local>
 */
...
#define OBJECT_NOTIFY_NATIVE_ARGS 1
#define OBJECT_NOTIFY_ALL_NATIVE_ARGS 1
#define OBJECT_WAIT_NATIVE_ARGS 1
#define OBJECT_WAIT_INTEGER_NATIVE_ARGS 2
